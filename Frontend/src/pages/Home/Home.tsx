...
export default function Home() {
  ...
  return (
    <main className="h-dvh touch-pan-y overflow-x-hidden overflow-y-auto overscroll-y-contain bg-[#0a0e20] md:h-auto md:min-h-dvh md:overflow-y-visible">
      <div className="mx-auto flex min-h-full w-full max-w-6xl flex-col justify-start px-4 pt-8 pb-[max(2rem,env(safe-area-inset-bottom))] sm:px-6 sm:py-10 md:min-h-dvh md:justify-center lg:px-8 lg:py-12">
